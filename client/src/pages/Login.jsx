    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4">
            ...
            >
                ...
                <input
                    className="w-full mb-2 px-3 py-2 rounded-lg border outline-none focus:border-[#1f4b99]"
                    placeholder="Email"
                    value={email}
                ...
                <input
                    type="password"
                    className="w-full mb-3 px-3 py-2 rounded-lg border outline-none focus:border-[#1f4b99]"
